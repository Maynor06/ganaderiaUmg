          ...
          <div className="px-6 [&:last-child]:pb-6" >
            <form onSubmit={handleSubmit} className="space-y-4" >
              <div className="space-y-2 " >
                ...
                <div className="flex justify-center items-center focus:border border-[#718096] " >
                  <PermIdentityOutlined sx={{color: "#718096"}} />
                  <input className="file:text-foreground text-[#718096] placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md py-1 text-base bg-input-background transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive pl-3" 
                  type="text" placeholder="Ingrese su usuario" value={username} onChange={e => setUserName(e.target.value)} required />
                </div>
              </div>
              <div className="space-y-2" >
