...
import TablaMaquinaria from "@/tools/TablaMaquinaria";

const COLUMNS = ['ID', 'Nombre', 'Tipo', 'Estado', 'Fecha de Adquisición'];
const rowsNameP = ['id', 'nombre', 'tipo', 'estado', 'fechaAdquisición'];

const Maquinaria = ({data}) => {
    ...
    >
        ...
        Nueva maquinaria
                ...
                <TablaMaquinaria colums={COLUMNS} rows={data} rowsname={rowsNameP} />
            </div>
        </div>
