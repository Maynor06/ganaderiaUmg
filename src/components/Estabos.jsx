            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        {/* Botón Exportar */}
                        <button
                            onClick={() => Api.getDocument("establo", "excel")}
                            data-slot="button"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" >
                    {data.map((establo, index) => (
                        <div data-slot="card" key={index} className="bg-card text-card-foreground flex flex-col gap-6 rounded-xl border hover:shadow-lg transition-shadow">
    <div 
        ...
        <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
                ...
                <svg 
                    ...
                    strokeLinecap="round" 
                    strokeLinejoin="round" 
                    className="lucide lucide-warehouse w-5 h-5 text-accent" 
                    aria-hidden="true"
                >
                ...
                <h4 data-slot="card-title" className="text-base">{establo.nombre} </h4>
            </div>
    ...
    <div data-slot="card-content" className="px-6 [&:last-child]:pb-6 space-y-4">
        ...
        <div className="space-y-2">
            <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">32 / {establo.capacidad} {parseInt((32 / establo.capacidad) * 100)}%  </span>
            </div>
            <div 
                aria-valuemax="100" 
                aria-valuemin="0" 
            ...
            >
                ...
                <div 
                    ...
                    style={{ transform: 'translateX(-9%)' }} // Estilo en línea convertido a objeto JS
                />
            </div>
        </div>
        ...
        <div className="flex items-center gap-2 text-sm">
            ...
            <svg 
                ...
                strokeLinecap="round" 
                strokeLinejoin="round" 
                className="lucide lucide-users w-4 h-4 text-muted-foreground" 
                aria-hidden="true"
            >
            ...
            <span className="font-medium">{establo.nombreEncargado} </span>
        </div>
